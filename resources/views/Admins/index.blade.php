...
<!-- 左侧开始 -->
 ...
 <ul>
  ...
  <li><a href="/admins/user"><i class=""></i><em>用户管理</em></a></li>
  ...
  <ul>
  <!-- <li><a href="/admins/articlecategory"><i class="articleCat"></i><em>文章分类(公告)</em></a></li> -->
  <li><a href="/admins/article"><i class="article"></i><em>文章列表（公告）</em></a></li>
 </ul>
   <ul class="bot">
  ...
  <li><a href="/admins/order"><i class=""></i><em>订单管理</em></a></li>
  <li><a href="/admins/ad"><i class=""></i><em>广告位管理</em></a></li>
 </ul>
</div></div>
 <div id="dcMain"> <!-- 当前位置 -->
@section("zhuti")
